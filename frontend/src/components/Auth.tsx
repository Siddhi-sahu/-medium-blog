import { SignupInput } from "@siddhi-sahu/medium-common";
        ...
        <div className="flex justify-center">
            <div>
                ...
                <div className="">
                    ...
                    <div className="text-slate-500 px-12 mt-1">
                ...
                <div className="pt-5">
                    ...
                    <LabelledInput label="password" type={"password"} placeholder="six digits long..." onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
